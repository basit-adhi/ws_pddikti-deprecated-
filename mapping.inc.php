...
class mapdb
{
    ...
    private function peta_kolom()
    {
        $this->peta["field"] = array    (   /* tabel Referensi */
                                            ...
                                            "satuan_pendidikan"                         => array("npsn" => "kodept", "nm_lemb" => "namapt", "stat_pt" => "statuspt"),
                                            ...
                                            "aktivitas_mahasiswa tugasakhir"            => array("id" => "guidjudulakt", "id_sms" => "guidprodi", "id_jns_akt_mhs" => "idjenisaktivitaspddikti", "id_smt" => "kdtahunakademik", "judul_akt_mhs" => "judulkaryatulis", "a_komunal" => "komunal"),
                                            ...
                                            "bimbing_mahasiswa"                         => array("id" => "guid", "id_akt_mhs" => "guidjudulakt", "id_sdm" => "guiddosen", "urutan_promotor" => "nourut", "id_katgiat" => "id_katgiat"),
                                            "uji_mahasiswa"                             => array("id" => "guid", "id_akt_mhs" => "guidjudulakt", "id_sdm" => "guiddosen", "urutan_uji" => "nourut", "id_katgiat" => "id_katgiat"),
    ...
    private function peta_injek()
    {
        $this->peta["inject"] = array 
                                (  // tipe insert: table, filter, tahunakademik, tandatahunakademik, istahunakademikkrs, type=insert
                                    ...
                                    "mahasiswa_pt lulus"                        => array( "table"               => "pddikti_v_lulus_mahasiswa m",
                                                                                          ...
                                                                                          "istahunakademikkrs"  => false,
                                                                                          "type"                => "update",
                                                                                          "fieldupdate"         => array("id_jns_keluar","tgl_keluar","ket","sk_yudisium","tgl_sk_yudisium","ipk","no_seri_ijazah"),
        ...
        //                                                                          "filter"              => "isnull(guidinsert) and m.isignore=0 and (isnull(kdyudisium) or kdyudisium=0)",
                                    ...
                                    "bimbing_mahasiswa"                         => array( "table"               => "pddikti_v_dosen_pembimbing p",
                                                                                          "filter"              => "isignore=0",
                                                                                          "tahunakademik"       => "kdtahunakademik",
                                                                                          "tandatahunakademik"  => "=",
                                                                                          "istahunakademikkrs"  => false,
                                    ...
                                    "uji_mahasiswa"                             => array( "table"               => "pddikti_v_dosen_penguji p",
                                                                                          "filter"              => "isignore=0",
                                                                                          "tahunakademik"       => "kdtahunakademik",
                                                                                          "tandatahunakademik"  => "=",
                                                                                          "istahunakademikkrs"  => false,
                                    ...
                                    "mahasiswa_pt updatedata"                  => array(  "table"               => "pddikti_v_mahasiswa_pt m",
                                                                                          ...
                                                                                          "istahunakademikkrs"  => true,
                                                                                          "type"                => "update",
                                                                                          "fieldupdate"         => array("mulai_smt", "sks_diakui", "id_jns_daftar"),//, "id_pt_asal", "id_prodi_asal"
                                                                                          "fieldwhere"          => array("id_reg_pd"),
                                                                                          "ignoreinject"        => true,
    ...
    private function peta_pk()
    {
        $this->peta["pk"]   = array (   /* tabel Referensi */
                                        ...
                                        "bimbing_mahasiswa"                         => array("id", "kdkaryatulispenguji"),
                                        "uji_mahasiswa"                             => array("id", "kdkaryatulispenguji"),
    ...
    private function peta_guid()
    {
        $this->peta["guid"] = array (   /* tabel Referensi tidak memerlukan mapping ini */
                                        ...
                                        "satuan_pendidikan"                         => array(   array(  "guid"                          => array("id_sp", "k.guid"), 
                                                                                                        "variable"                      => array("npsn", "k.kodept"), 
                                                                                                        "table"                         => array("check" => "pt_perguruantinggi k", "update" => "pt_perguruantinggi k"), 
                                                                                                        "prerequisite"                  => "", 
                                                                                                        "filter"                        => "", 
                                                                                                        "infotambahanerror"             => "", 
                                                                                                        "order by"                      => "", 
                                        ...
                                        "bimbing_mahasiswa"                         => array(   array(  "guid"                          => array("id_bimb_mhs", "guid"), 
                                        ...
                                        "uji_mahasiswa"                             => array(   array(  "guid"                          => array("id_uji_mhs", "guid"), 
                                                                                                        "variable"                      => array("a.id_akt_mhs,s.id_sdm,k.id_katgiat", "guidjudulakt,guiddosen,id_katgiat"), 
